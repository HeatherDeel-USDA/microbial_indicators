...
ml_EC_16S <- readRDS("/project/soil_micro_lab/micro_indicators/machine_learning/ml_EC_RA.RDS")

# change column numbers as necessary
# include all ECs, clay, ClimateZ, and ace
ml_EC_16S_ACE <- ml_EC_16S[,c(2:2445,2515,2547,2522)]
...
saveRDS(cf.ace, paste("/project/soil_micro_lab/micro_indicators/machine_learning/16S_EC/ACE_model_results_RA_clay_climate/ACE_EC_RA_clay_climate_cf", args[1], ".RDS", sep = ""))
...
saveRDS(cf.pvso, paste("/project/soil_micro_lab/micro_indicators/machine_learning/16S_EC/ACE_model_results_RA_clay_climate/ACE_EC_RA_clay_climate_cf_obs_vs_pred", args[1], ".RDS", sep = ""))
...
ggsave(paste("/project/soil_micro_lab/micro_indicators/machine_learning/16S_EC/ACE_model_results_RA_clay_climate/ACE_EC_RA_clay_climate_pred_vs_obs", args[1], ".pdf", sep = ""), unit = "in", width = 6, height = 6, dpi = 300, device = "pdf")
...
write.table(cbind(task_num,r2_val,p_val), 
            file = "/project/soil_micro_lab/micro_indicators/machine_learning/16S_EC/ACE_model_results_RA_clay_climate/ACE_EC_RA_clay_climate_stats.csv", 
...
write.csv(ace.imp, paste("/project/soil_micro_lab/micro_indicators/machine_learning/16S_EC/ACE_model_results_RA_clay_climate/ACE_EC_RA_clay_climate_var_importance", args[1], ".csv", sep = ""), row.names = TRUE)
