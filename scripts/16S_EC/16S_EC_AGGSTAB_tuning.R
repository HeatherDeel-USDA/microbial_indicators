...
# save tune results
saveRDS(rf_tune_results, "/project/soil_micro_lab/micro_indicators/machine_learning/16S_EC/AGGSTAB_model_results/ml_EC_16S_AGGSTAB_tune_results.RDS")
...
# save tune results
saveRDS(rf_tune_results, "/project/soil_micro_lab/micro_indicators/machine_learning/16S_EC/AGGSTAB_model_results/ml_EC_16S_AGGSTAB_tune_results_clay_climate.RDS")
