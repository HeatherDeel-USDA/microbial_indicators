...
for (myVar in myVars) {
  ...
  ggsave(paste0("../../dan_out/", myVar, "_", myData, "_varimp.png"), device='png', dpi=600, height=6, width=8)
...
meansDF.wide
write.csv(meansDF.wide, paste0("../../dan_out/", "meansDF.wide.", myData, ".csv"))
meansDF.long
...
p <- ggdendrogram(dhc, rotate = TRUE) + 
  ...
  xlab('') 
p
ggsave(paste0("../../dan_out/", "All_", myData, "_dendro.png"), device='png', dpi=600, height=4, width=6)
