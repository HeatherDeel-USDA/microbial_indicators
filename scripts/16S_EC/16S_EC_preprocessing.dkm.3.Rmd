...
t1$cal_network(COR_p_thres = 0.01, COR_cut=0.9, add_taxa_name='order', 
               delete_unlinked_nodes=FALSE)
t1$cal_module(method ='cluster_fast_greedy')
t1$cal_eigen()
t1$get_node_table(node_roles=FALSE) 
t1$get_edge_table()
write.csv(t1$res_node_table, 'res_node_table_0.9.csv')
...
ggsave(paste0("../../dan_out_2/", "All_", myData, "_network_0.9.png"), device='png', dpi=600, height=8, width=11)
...
#t2 <- t1$trans_comm(use_col="module", abundance=TRUE)
train <- cbind(meta[,'ace'], t1$res_eigen)
names(train)[1] <- 'ace'
...
cf.train <- cforest(ace ~ ., data = train,
                    controls = my_cforest_control)
