...
saveRDS(cf.ace, paste("/project/soil_micro_lab/micro_indicators/machine_learning/16S_EC/ACE_model_results_RA_CNC_noclay_noclimate/ACE_EC_RA_CNC_noclay_noclimate_cf", args[1], ".RDS", sep = ""))
...
saveRDS(cf.pvso, paste("/project/soil_micro_lab/micro_indicators/machine_learning/16S_EC/ACE_model_results_RA_CNC_noclay_noclimate/ACE_EC_RA_CNC_noclay_noclimate_cf_obs_vs_pred", args[1], ".RDS", sep = ""))
...
ggsave(paste("/project/soil_micro_lab/micro_indicators/machine_learning/16S_EC/ACE_model_results_RA_CNC_noclay_noclimate/ACE_EC_RA_CNC_noclay_noclimate_pred_vs_obs", args[1], ".pdf", sep = ""), unit = "in", width = 6, height = 6, dpi = 300, device = "pdf")
...
write.table(cbind(task_num,r2_val,p_val), 
            file = "/project/soil_micro_lab/micro_indicators/machine_learning/16S_EC/ACE_model_results_RA_CNC_noclay_noclimate/ACE_EC_RA_CNC_noclay_noclimate_stats.csv", 
...
write.csv(ace.imp, paste("/project/soil_micro_lab/micro_indicators/machine_learning/16S_EC/ACE_model_results_RA_CNC_noclay_noclimate/ACE_EC_RA_CNC_noclay_noclimate_var_importance", args[1], ".csv", sep = ""), row.names = TRUE)
