...
top_TAX <- top_TAX %>%
  ...
  drop_na() %>% # if not present in a study values will be NA, so remove ### Q: a species has to be present in all 4 datasets in order to be included? This does exclude some top 10 important species 
