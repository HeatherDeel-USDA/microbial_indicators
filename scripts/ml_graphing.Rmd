...
### Boxplot of R^2 values for ACE and SEMWISE testing
```{r}
ml_stats <- read_xlsx("machine_learning/16S_EC/ml_EC_stats_ACE_SEMWISE.xlsx")
...
ggsave("figures/ml_ACE_SEMWISE_r2.pdf", unit = "in", width = 8, height = 6, dpi = 300, device = "pdf")
ggsave("figures/ml_ACE_SEMWISE_r2.tiff", unit = "in", width = 8, height = 6, dpi = 300, device = "tiff")
```
