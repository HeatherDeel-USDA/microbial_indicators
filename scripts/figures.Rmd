...
all_merged2 <- apply(all_merged2,2,as.character)
saveRDS(all_merged2, "picrust2_files/ECs_per_species.RDS")
write.csv(all_merged2, file = "picrust2_files/ECs_per_species.csv")
