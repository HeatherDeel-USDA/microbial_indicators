...
library(factoextra) # need to install these
library(factoMineR)
...
```{r}
# can use code above to get enzymes and metadata together. Just need to join with something that has metabolism categories
```
