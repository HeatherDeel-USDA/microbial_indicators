...
### almost there, but need to figure this out - create a list of the plot items themselves. Seems like it's just creating a list of the character strings
plot_list <- list(metabolisms)
