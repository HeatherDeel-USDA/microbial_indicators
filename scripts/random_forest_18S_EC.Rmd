...
############# need to edit section so it just reads in the tuning results before the grid, then manually change the grid, and then proceeds to fitting the model in a 1-25 loop
